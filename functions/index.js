...
exports.paymentReminder = onSchedule(
    ...
    async () => {
      ...
      snapshot.forEach((doc) => {
        ...
        // Skip trial lessons (they're free)
        if (data.lesson_type === "trial") return;

        // Skip if already confirmed
        if (data.payment_confirmed) return;

        // Must have at least one upcoming lesson
        ...
        // Get next upcoming lesson date/time
        ...
        const nextDateFormatted = nextLesson ?
          new Date(nextLesson.date + "T12:00:00").toLocaleDateString("tr-TR", {
        ...
        const mailOptions = {
          ...
          to: email,
          subject: "⚠ Ders ödemesi henüz yapılmadı — Berkay Er Academy",
          html: `
<!DOCTYPE html>
<html lang="tr">
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden;max-width:560px;">
        ...
        <tr><td style="padding:32px;">
          ...
          <div style="background:#fff8ed;border:1px solid #f0c060;border-radius:6px;padding:16px 20px;margin-bottom:24px;">
            <p style="margin:0;font-size:14px;color:#b86800;">
              ⚠ <strong>Ders ödemeniz henüz alınmadı.</strong>
            </p>
          ...
          <p style="margin:0 0 12px;font-size:14px;color:#444;line-height:1.6;">
            Lütfen ödemenizi en kısa sürede aşağıdaki IBAN'a gönderin:
          </p>
          ...
          <p style="margin:0 0 24px;font-size:13px;color:#666;line-height:1.6;">
            Ödeme yaptıktan sonra sisteminizden bildirim göndermeyi unutmayın.
            Herhangi bir sorunuz olursa bu emaile yanıt verebilirsiniz.
          </p>
        ...
        <tr><td style="background:#f8f8f8;padding:20px 32px;text-align:center;border-top:1px solid #eee;">
          ...
          <p style="margin:4px 0 0;font-size:11px;color:#ccc;">Bu email otomatik gönderilmiştir.</p>
        </td></tr>
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden;max-width:560px;">
        ...
        <tr><td style="padding:32px;">
          <p style="margin:0 0 16px;font-size:15px;color:#222;">Merhaba <strong>${name}</strong>,</p>
          <div style="background:#fff8ed;border:1px solid #f0c060;border-radius:6px;padding:16px 20px;margin-bottom:24px;">
            <p style="margin:0;font-size:14px;color:#b86800;">⚠ <strong>Ders ödemeniz henüz alınmadı.</strong></p>
            <p style="margin:8px 0 0;font-size:13px;color:#666;">Yaklaşan dersiniz: <strong style="color:#333;">${nextDateFormatted} – ${nextLesson.time}</strong></p>
          </div>
          <p style="margin:0 0 12px;font-size:14px;color:#444;line-height:1.6;">Lütfen ödemenizi en kısa sürede aşağıdaki IBAN'a gönderin:</p>
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f8f8;border-radius:6px;padding:16px;margin-bottom:24px;">
            <tr><td style="font-size:12px;color:#888;padding:3px 0;">Banka</td><td style="font-size:13px;color:#333;font-weight:bold;text-align:right;">Garanti Bankası</td></tr>
            <tr><td style="font-size:12px;color:#888;padding:3px 0;">İsim</td><td style="font-size:13px;color:#333;font-weight:bold;text-align:right;">Muhammet Berkay Er</td></tr>
            <tr><td style="font-size:12px;color:#888;padding:3px 0;">IBAN</td><td style="font-size:13px;color:#222;font-weight:bold;text-align:right;font-family:monospace;letter-spacing:1px;">TR35 0006 2000 6870 0006 8982 06</td></tr>
          </table>
          <p style="margin:0 0 24px;font-size:13px;color:#666;line-height:1.6;">Ödeme yaptıktan sonra sisteminizden bildirim göndermeyi unutmayın.</p>
          <a href="https://berkayeracademy.com/booking.html" style="display:inline-block;background:#e8b84b;color:#060609;font-size:13px;font-weight:bold;padding:12px 28px;border-radius:4px;text-decoration:none;letter-spacing:1px;">Ders Panelinize Git →</a>
        </td></tr>
        <tr><td style="background:#f8f8f8;padding:20px 32px;text-align:center;border-top:1px solid #eee;">
          <p style="margin:0;font-size:11px;color:#aaa;">Berkay Er Academy · berkayeracademy.com</p>
