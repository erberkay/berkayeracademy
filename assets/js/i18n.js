(function () {
  var T = {
    ...
    bk_upsell_text:        { tr: `Aylık planda ders başı {monthly}. Tek derse göre her derste {save} (%{pct}) tasarruf edersin.`,
                             en: `On a monthly plan each lesson is {monthly} — that's {save} ({pct}%) less per lesson than a single booking.` },
