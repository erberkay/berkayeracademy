(function () {
  var T = {
    ...
    eg_modpush3_tag:  { tr: 'OYUN',                          en: 'GAME' },
    eg_modpush3_title:{ tr: "Ableton Push 3'ü Tanı",          en: 'Meet Ableton Push 3' },
    eg_modpush3_level:{ tr: 'İnteraktif Alıştırma',          en: 'Interactive Exercise' },
    eg_modpush3_t1:   { tr: '27 gerçek kontrolü tek tek keşfet', en: 'Discover all 27 real controls one by one' },
    eg_modpush3_t2:   { tr: 'Göreve göre doğru düğmeye dokun, anında öğren', en: 'Tap the right button for each task, learn instantly' },
    eg_modpush3_t3:   { tr: 'Cihaz görseli gerçek Figma tasarımından', en: 'Device artwork from a real Figma design' },
    eg_modpush3_btn:  { tr: 'Oyunu Aç →',                    en: 'Open the Game →' },
