(function () {
  var T = {
    ...
    idx_perform_tag:      { tr: 'Live Set Hybrid - DJ', en: 'Live Set Hybrid - DJ' },
    ...
    idx_hook:             { tr: "Kafanda dönen ritimler var, kulaklarında bir sound var ama ekrana bakınca nereye basacağını bilmiyorsun. Ya da yıllardır üretiyorsun, ancak sesler hâlâ istediğin yere gelemiyor. Bu ikisi de aynı kapıya çıkıyor: <strong>doğru rehberlik eksikliği.</strong> Berkay Er Academy'de öğrendiğin şey sadece bir yazılım değil; kafandaki müziği sahneye taşıyan bir dil. Peaktime Techno'nun ham enerjisinden Melodic Techno'nun duygusal katmanlarına, Afro House'un ritim zenginliğinden Dark Electronic'in karanlık dokusuna kadar — bu eğitim senin sesin için tasarlandı.", en: "You have rhythms spinning in your head, a sound in your ears, but you don't know where to click when you look at the screen. Or you've been producing for years, but the sounds still can't reach where you want them to. Both lead to the same door: <strong>the lack of proper guidance.</strong> What you learn at Berkay Er Academy isn't just software; it's a language that takes the music in your head to the stage. From the raw energy of Peaktime Techno to the emotional layers of Melodic Techno, from Afro House's rhythmic richness to Dark Electronic's dark texture — this education was designed for your sound." },
    idx_testimonial1:     { tr: '"Berkay hoca hem teknik hem de müzikal açıdan çok iyi aktarıyor. İlk dersimden sonra zaten fark yarattığını hissettim."', en: '"Berkay\'s teaching is excellent both technically and musically. I could already feel the difference after my first lesson."' },
    idx_testimonial2:     { tr: '"Melodic techno üzerine bu kadar derinlikli anlatan başka biri görmedim. Ableton workflow\'um tamamen değişti."', en: '"I\'ve never seen anyone explain melodic techno in such depth. My Ableton workflow has completely changed."' },
    idx_testimonial3:     { tr: '"Ücretsiz deneme dersinden sonra zaten devam etmek istedim. Çok samimi ve yönlendirici bir eğitim."', en: '"After the free trial lesson I already wanted to continue. A very genuine and guiding education."' },
    ...
    eg_hero_h1b: { tr: 'eğitimi', en: 'education' },
    ...
    eg_lab_teaser:    { tr: 'Ableton Lab — Synthesizer, Beat Maker, Mixer ve Arrangement Builder ile dersleri interaktif olarak pekiştir', en: 'Ableton Lab — Reinforce lessons interactively with Synthesizer, Beat Maker, Mixer and Arrangement Builder' },
    ...
    eg_modpush3_tag:  { tr: 'LAB',                           en: 'LAB' },
    eg_modpush3_title:{ tr: 'Push 3 Laboratuvarı',           en: 'Push 3 Lab' },
    eg_modpush3_level:{ tr: 'Öğretici + Emülatör',           en: 'Tutorial + Emulator' },
    eg_modpush3_t1:   { tr: "Adım adım öğretici: pad'ler, Scale, Wavetable, davul", en: 'Step-by-step tutorial: pads, Scale, Wavetable, drums' },
    eg_modpush3_t2:   { tr: "Tarayıcıda çalan Push 3: 64 pad, Scale modu, encoder'lar", en: 'A Push 3 that plays in your browser: 64 pads, Scale mode, encoders' },
    eg_modpush3_t3:   { tr: 'Kontrolü Bul oyunu ve görevler — tamamen ücretsiz', en: 'Find the Control game and tasks — completely free' },
    eg_modpush3_btn:  { tr: 'Laboratuvarı Aç →',             en: 'Open the Lab →' },
    ...
    prof_edit_btn:    { tr: 'Profili Düzenle',            en: 'Edit Profile' },
    ...
    prof_signin_err:  { tr: 'Giriş hatası:',                 en: 'Sign-in error:' },
    ...
    prof_settings_btn:{ tr: 'Görünüm Ayarları',          en: 'Appearance' },
    prof_close:       { tr: 'Kapat',                        en: 'Close' },
    prof_theme_label: { tr: 'Tema',                         en: 'Theme' },
    prof_theme_title: { tr: 'Renk Teması',                  en: 'Color Theme' },
    prof_theme_sub:   { tr: 'Koyu veya açık arka plan',     en: 'Dark or light background' },
    prof_dark_btn:    { tr: 'Koyu',                      en: 'Dark' },
    prof_light_btn:   { tr: 'Açık',                      en: 'Light' },
    ...
    forum_all_members:   { tr: 'Tüm Üyeleri Gör →', en: 'See All Members →' },
    ...
    members_search_ph:    { tr: 'İsim, tür veya araç ara...', en: 'Search name, genre or tool...' },
    ...
    bk_samples_hint:       { tr: 'ders öncesi kurulum gerekli', en: 'install before your lesson' },
    bk_plugins_hint:       { tr: 'derslerde kullanılan araçlar', en: 'tools used in lessons' },
    ...
    bk_rule_exceptions:    { tr: 'Erteleme İstisnaları', en: 'Reschedule Exceptions' },
    bk_rule_exceptions_desc: { tr: '', en: '' },
    ...
    bk_single_note:        { tr: 'Aylık ders alan öğrencilerin ders saati değişiklikleri ile çakıştığında <strong>aylık ders alan öğrencilerin öncelikleri vardır</strong>. Bu nedenle seçtiğiniz saat iptal edilebilir.', en: 'When conflicting with schedule changes of monthly-plan students, <strong>monthly students have priority</strong>. Your selected slot may be cancelled.' },
    bk_slot_sel_label:     { tr: 'Seçili: ',            en: 'Selected: ' },
    ...
    bk_slot_multi_hint:    { tr: 'Gün & Saat Seç <span class="hint-sub">(birden fazla seçebilirsin)</span>', en: 'Select Day & Time <span class="hint-sub">(you can pick multiple)</span>' },
    ...
    bk_lab_desc:           { tr: '<strong style="color:var(--white);">Derse başlamadan önce</strong> Ableton Lab\'ı tamamlaman gerekiyor. Synthesizer, Beat Maker, Mixer ve Arrangement araçlarını keşfet — bu temel olmadan dersler çok daha zor olacak.', en: '<strong style="color:var(--white);">Before starting lessons</strong> you need to complete Ableton Lab. Explore the Synthesizer, Beat Maker, Mixer and Arrangement tools — lessons will be much harder without this foundation.' },
    bk_lab_btn2:           { tr: "Lab'a Git →",          en: 'Go to Lab →' },
    bk_lab_before_strong:  { tr: 'Derse başlamadan önce', en: 'Before starting lessons' },
    bk_lab_before_desc:    { tr: "Ableton Lab'ı tamamlaman gerekiyor. Synthesizer, Beat Maker, Mixer ve Arrangement araçlarını keşfet — bu temel olmadan dersler çok daha zor olacak.", en: "you need to complete Ableton Lab. Explore the Synthesizer, Beat Maker, Mixer and Arrangement tools — lessons will be much harder without this foundation." },
    ...
    bk_slot_busy_err:      { tr: 'saati dolu, lütfen admin ile iletişime geçin.', en: 'time slot is full, please contact the admin.' },
    bk_reschedule_done:    { tr: '✓ Ders ertelendi →', en: '✓ Lesson rescheduled →' },
    bk_price_single_label: { tr: 'Tek ders ücreti:', en: 'Single lesson price:' },
    bk_price_total_label:  { tr: 'Tahmini toplam:', en: 'Estimated total:' },
    bk_price_per_lesson:   { tr: 'ders × ', en: 'lessons × ' },
    bk_price_per_slot:     { tr: 'TL/ders saat', en: 'TL/slot' },
    ...
    bk_credit_month_label: { tr: 'Bu ay erteleme hakkı:', en: 'This month reschedule credits:' },
    bk_credit_total_label: { tr: 'Toplam:', en: 'Total:' },
    bk_credit_lessons_lbl: { tr: 'ders', en: 'lessons' },
    ...
    bk_welcome_zoom_desc:  { tr: 'Ödeme onaylandıktan sonra aktifleşir. Ödeme yapılmadığı sürece <span style="color:rgba(239,68,68,.7);font-weight:700;">Ödeme Yapılmadı</span> olarak görünür ve derse katılamazsınız.', en: 'Activates after payment is confirmed. Until payment is made it shows as <span style="color:rgba(239,68,68,.7);font-weight:700;">Payment Not Made</span> and you cannot join.' },
    bk_welcome_pay_title:  { tr: 'Ödeme Nasıl Yapılır?', en: 'How to Make a Payment?' },
    bk_welcome_pay_desc:   { tr: 'Garanti Bankası IBAN\'ına havale yapın, ardından aşağıdaki <span style="color:#e8b84b;">₺ Ödeme Yaptım</span> butonuna basın. Admin onaylayınca buton aktifleşir.', en: 'Transfer to the Garanti Bank IBAN, then click the <span style="color:#e8b84b;">₺ I Made a Payment</span> button below. The button activates after admin confirmation.' },
    bk_welcome_resch_title: { tr: 'Ders Erteleme', en: 'Reschedule' },
    bk_welcome_resch_desc: { tr: 'Dersinizi <span style="color:#63b3ed;font-weight:700;">en az 24 saat öncesinden</span> erteleyebilirsiniz. Ders kartındaki <span style="color:#63b3ed;">↺ Ertele</span> butonunu kullanın — yeni tarih seçtikten sonra admin onayına gönderilir.', en: 'You can reschedule <span style="color:#63b3ed;font-weight:700;">at least 24 hours in advance</span>. Use the <span style="color:#63b3ed;">↺ Reschedule</span> button on the lesson card — sent for admin approval after selecting a new date.' },
    bk_welcome_qa_title:   { tr: 'Soru & Cevap', en: 'Q&A' },
    bk_welcome_qa_desc:    { tr: 'Panelin altındaki <span style="color:#a855f7;font-weight:700;">Soru Sor</span> alanından doğrudan mesaj atabilirsiniz. Ders dışı sorular, teknik konular — her şey için kullanabilirsiniz.', en: 'You can send direct messages from the <span style="color:#a855f7;font-weight:700;">Ask a Question</span> area at the bottom. Questions, technical topics — use it for anything.' },
    bk_welcome_lab_title:  { tr: 'Ableton Lab & Forum', en: 'Ableton Lab & Forum' },
    bk_welcome_lab_desc:   { tr: 'Ders dışında da öğrenmeye devam edin — <span style="color:#e8b84b;font-weight:700;">Ableton Lab</span>\'da interaktif synthesizer, beat maker ve mixer araçları var. <span style="color:#e8b84b;font-weight:700;">Forum</span>\'da diğer öğrencilerle fikir paylaşın.', en: 'Keep learning outside of lessons — <span style="color:#e8b84b;font-weight:700;">Ableton Lab</span> has interactive synthesizer, beat maker and mixer tools. Share ideas with other students in the <span style="color:#e8b84b;font-weight:700;">Forum</span>.' },
    ...
    bk_qa_send_btn:        { tr: '→ Gönder', en: '→ Send' },
    ...
    bk_zoom_active_soon:   { tr: 'sonra aktif olacak', en: 'until active' },
    bk_zoom_in_progress_s: { tr: 'Ders devam ediyor', en: 'Lesson in progress' },
    bk_my_note_label:      { tr: 'NOTUM', en: 'MY NOTE' },
    ...
    bk_qa_desc:            { tr: 'Ders hakkında aklına takılan soruları buradan sorabilirsin. Berkay Er yanıtlayacak.', en: 'You can ask questions about your lessons here. Berkay Er will answer.' },
    ...
    bk_monthly_plan:       { tr: 'Aylık Plan', en: 'Monthly Plan' },
    bk_single_lesson:      { tr: 'Tek Ders', en: 'Single Lesson' },
    bk_upsell_title:       { tr: `Aylık planda ders başı daha uygun`, en: `Cheaper per lesson on a monthly plan` },
    bk_upsell_text:        { tr: `Aylık planda ders başı {single} yerine {monthly} — her derste {save} ucuz. {n} derslik planda toplam {total} tasarruf edersin.`,
                             en: `On a monthly plan each lesson is {monthly} instead of {single} — {save} less per lesson, {total} less over the {n}-lesson plan.` },
    bk_upsell_btn:         { tr: `Aylık Plana Geç`, en: `Switch to monthly plan` },
    ...
    bk_duration:           { tr: 'Süre', en: 'Duration' },
    bk_lessons_per_month:  { tr: 'Aylık Ders Sayısı', en: 'Lessons Per Month' },
    bk_lpm_sub:            { tr: 'DERS/AY', en: 'LES/MO' },
    bk_start_date:         { tr: 'Başlangıç Tarihi', en: 'Start Date' },
    bk_optional:           { tr: '(isteğe bağlı)', en: '(optional)' },
    bk_slot_label:         { tr: 'Gün & Saat Seç', en: 'Select Day & Time' },
    bk_slot_hint:          { tr: '(birden fazla seçebilirsin)', en: '(you can pick multiple)' },
    ...
    bk_access_pkg_title:   { tr: 'Ders Paketi', en: 'Lesson Package' },
    bk_access_pkg_desc:    { tr: 'Aylık ders paketi için erişim talebi gönder. Berkay Er inceleyip onaylayacak.', en: 'Send an access request for a monthly lesson package. Berkay Er will review and approve.' },
    bk_access_date_lbl:    { tr: 'TARİH', en: 'DATE' },
    bk_access_time_lbl:    { tr: 'SAAT SEÇ', en: 'SELECT TIME' },
    bk_access_avail:       { tr: '● Müsait', en: '● Available' },
    bk_access_busy:        { tr: '● Dolu', en: '● Taken' },
    ...
    bk_access_send_btn:    { tr: 'Erişim Talebi Gönder →', en: 'Send Access Request →' },
    ...
    p3_card_tut_badge:  { tr: 'Önerilen',            en: 'Recommended' },
    p3_card_tut_title:  { tr: 'Öğretici',            en: 'Tutorial' },
    p3_card_tut_desc:   { tr: "Push 3'ü sıfırdan adım adım öğren: nota çalmaktan Wavetable ile ses tasarımına, davul programlamaktan kayda.", en: 'Learn Push 3 from scratch, step by step: from playing notes to sound design with Wavetable, from programming drums to recording.' },
    p3_card_tut_first:  { tr: 'İlk kez mi? Buradan başla.', en: 'First time? Start here.' },
    p3_card_l1_badge:   { tr: 'Oyun',                en: 'Game' },
    p3_card_l1_title:   { tr: 'Seviye 1 · Kontrolü Bul', en: 'Level 1 · Find the Control' },
    p3_card_l1_desc:    { tr: "Push 3'ün gerçek kontrollerini cihazın üstünde tek tek bul, her birinin ne işe yaradığını öğren.", en: "Find Push 3's real controls on the device one by one and learn what each one does." },
    p3_card_l2_badge:   { tr: 'Görev',               en: 'Tasks' },
    p3_card_l2_title:   { tr: 'Seviye 2 · Görevler', en: 'Level 2 · Tasks' },
    ...
    p3_card_free_title: { tr: 'Serbest Çal',         en: 'Free Play' },
    p3_card_free_desc:  { tr: "Kural yok, ipucu yok. Wavetable synth ve davul setiyle Push 3'ü gerçek bir cihaz gibi çal. Learn düğmesi seni derslere götürür.", en: 'No rules, no hints. Play Push 3 like the real device with the Wavetable synth and a drum kit. The Learn button takes you to the lessons.' },
