(function () {
  var T = {
    ...
    idx_hook:             { tr: "Kafanda dönen ritimler var, kulaklarında bir sound var ama ekrana bakınca nereye basacağını bilmiyorsun. Ya da yıllardır üretiyorsun, ancak sesler hâlâ istediğin yere gelemiyor. Bu ikisi de aynı kapıya çıkıyor: <strong style=\"color:#eeebe6;\">doğru rehberlik eksikliği.</strong> Berkay Er Academy'de öğrendiğin şey sadece bir yazılım değil; kafandaki müziği sahneye taşıyan bir dil. Peaktime Techno'nun ham enerjisinden Melodic Techno'nun duygusal katmanlarına, Afro House'un ritim zenginliğinden Dark Electronic'in karanlık dokusuna kadar — bu eğitim senin sesin için tasarlandı.", en: "You have rhythms spinning in your head, a sound in your ears, but you don't know where to click when you look at the screen. Or you've been producing for years, but the sounds still can't reach where you want them to. Both lead to the same door: <strong style=\"color:#eeebe6;\">the lack of proper guidance.</strong> What you learn at Berkay Er Academy isn't just software; it's a language that takes the music in your head to the stage. From the raw energy of Peaktime Techno to the emotional layers of Melodic Techno, from Afro House's rhythmic richness to Dark Electronic's dark texture — this education was designed for your sound." },
    ...
    prof_save_err:    { tr: '⚠️ Kayıt başarısız',           en: '⚠️ Save failed' },
    ...
    prof_light_btn:   { tr: '☀️ Açık',                      en: '☀️ Light' },
    ...
    bk_rule_reschedule_desc: { tr: 'Her ay bir kez ders erteleme hakkınız vardır.', en: 'You have the right to reschedule one lesson per month.' },
    bk_rule_notice_desc:   { tr: 'Dersinizi ertelemek isterseniz, en az 24 saat önce talep etmeniz gerekir. Ertelenen ders aynı ay içinde yapılmalıdır.', en: 'If you want to reschedule, request it at least 24 hours in advance. The rescheduled lesson must take place within the same month.' },
    bk_rule_limit_desc:    { tr: 'Aynı ay içinde ikinci kez ders ertelemek mümkün değildir.', en: 'It is not possible to reschedule a lesson twice in the same month.' },
    bk_rule_exceptions:    { tr: 'Erteleme İstisnaları', en: 'Reschedule Exceptions' },
    bk_rule_exceptions_desc: { tr: 'Sağlık sorunları veya acil durumlar gibi özel durumlarda istisna yapılabilir. Bu durumları belgelemeniz gerekebilir.', en: 'Exceptions may be made for special circumstances such as health issues or emergencies. Documentation may be required.' },
    bk_rule_late:          { tr: 'Derse Geç Kalma',     en: 'Late Arrival' },
    bk_rule_late_desc:     { tr: 'Derse 40 dakika içinde girilmezse, ders yapılmış sayılır. Ancak ders sonrası başka ders yoksa süre uzatılabilir.', en: 'If you do not join within 40 minutes the lesson is counted as completed. The time may be extended if there is no lesson after.' },
    ...
    bk_slot_single_hint:   { tr: 'Gün & Saat Seç <span style="color:var(--dim);font-size:.6rem;">(bir saat seç)</span>', en: 'Select Day & Time <span style="color:var(--dim);font-size:.6rem;">(pick one slot)</span>' },
    bk_slot_multi_hint:    { tr: 'Gün & Saat Seç <span style="color:var(--dim);font-size:.6rem;">(birden fazla seçebilirsin)</span>', en: 'Select Day & Time <span style="color:var(--dim);font-size:.6rem;">(you can pick multiple)</span>' },
    ...
    bk_lab_before:         { tr: 'ÖNCE ABLETON LAB\'I TAMAMLA', en: 'COMPLETE ABLETON LAB FIRST' },
    ...
    bk_reschedule_no_credit: { tr: 'Bu ay için erteleme hakkınız kalmadı.', en: 'You have no reschedule credits left for this month.' },
    ...
    bk_samples_title:      { tr: 'DERS İÇERİĞİ — Sample & Serum Presetler', en: 'LESSON CONTENT — Samples & Serum Presets' },
    ...
    bk_plugins_title:      { tr: 'PLUGIN LİSTESİ — Derslerde Kullanılan Araçlar', en: 'PLUGIN LIST — Tools Used in Lessons' },
