(function () {
  var T = {
    ...
    bk_rule_reschedule_desc: { tr: 'Her ay 1 ders erteleme hakkı vardır. Ek hak 500 TL ödeme ile alınır.', en: 'You get 1 reschedule per month. Extra rights can be purchased for 500 TL.' },
